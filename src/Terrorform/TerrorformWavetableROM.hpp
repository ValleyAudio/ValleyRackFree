...
static float** wavetables[NUM_TERRORFORM_WAVETABLES] = {
    ...
    wavetable_piano, wavetable_ebass, wavetable_pluck, wavetable_theremin,
    wavetable_symetric, wavetable_overtone1, wavetable_overtone2, wavetable_voice1,
    wavetable_voice2, wavetable_voice3, wavetable_voice4, wavetable_voice5,
    wavetable_voice6, wavetable_machine, wavetable_chip1, wavetable_chip2,
...
static long* wavetable_lengths[NUM_TERRORFORM_WAVETABLES] = {
    ...
    wavetable_symetric_lengths, wavetable_overtone1_lengths, wavetable_overtone2_lengths, wavetable_voice1_lengths,
    wavetable_voice2_lengths, wavetable_voice3_lengths, wavetable_voice4_lengths, wavetable_voice5_lengths,
    wavetable_voice6_lengths, wavetable_machine_lengths, wavetable_chip1_lengths, wavetable_chip2_lengths,
    wavetable_bitcrush1_lengths, wavetable_bitcrush2_lengths, wavetable_vgame_lengths, wavetable_linear1_lengths,
    wavetable_distort_lengths, wavetable_grit_lengths, wavetable_gmtry_1_lengths, wavetable_gmtry_2_lengths,
    wavetable_gmtry_3_lengths, wavetable_plaits2_lengths, wavetable_plaits3_lengths, wavetable_plaits4_lengths
};
...
static int32_t wavetable_sizes[NUM_TERRORFORM_WAVETABLES] = {
    ...
    WAVETABLE_SYMETRIC_NUM, WAVETABLE_OVERTONE1_NUM, WAVETABLE_OVERTONE2_NUM, WAVETABLE_VOICE1_NUM,
    WAVETABLE_VOICE2_NUM, WAVETABLE_VOICE3_NUM, WAVETABLE_VOICE4_NUM, WAVETABLE_VOICE5_NUM,
    WAVETABLE_VOICE6_NUM, WAVETABLE_MACHINE_NUM, WAVETABLE_CHIP1_NUM, WAVETABLE_CHIP2_NUM,
    WAVETABLE_BITCRUSH1_NUM, WAVETABLE_BITCRUSH2_NUM, WAVETABLE_VGAME_NUM, WAVETABLE_LINEAR1_NUM,
    WAVETABLE_DISTORT_NUM, WAVETABLE_GRIT_NUM, WAVETABLE_GMTRY_1_NUM, WAVETABLE_GMTRY_2_NUM,
    WAVETABLE_GMTRY_3_NUM, WAVETABLE_PLAITS2_NUM, WAVETABLE_PLAITS3_NUM, WAVETABLE_PLAITS4_NUM
};
